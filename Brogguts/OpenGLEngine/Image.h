...
@interface Image : NSObject {
	...
	//////////////////// Singleton Managers
    TextureSingleton *textureSingleton;					// Reference to the texture manager
    GameController *sharedGameController;			// Reference to the game controller
    ImageRenderSingleton *imageRenderSingleton;	// Reference to the render manager
	...
	CGPoint renderPoint;						// Point at which the image will be rendered
...
// This will cause this image to be rendered when the image render manager is next 
// asked to render.
- (void)render;
