...
static SoundSingleton* sharedSoundSingleton = nil;

@interface SoundSingleton (Private)
...
+ (id)allocWithZone:(NSZone *)zone
{
	@synchronized(self) {
		if (sharedSoundSingleton == nil) {
			sharedSoundSingleton = [super allocWithZone:zone];
			return sharedSoundSingleton;
		}
	}
...
@implementation SoundSingleton (Private)
