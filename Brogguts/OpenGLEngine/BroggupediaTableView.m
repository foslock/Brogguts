...
@implementation BroggupediaTableView
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        UIBarButtonItem *temporaryBarButtonItem = [[UIBarButtonItem alloc]
                                                   initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(closeBroggupedia:)]; 
